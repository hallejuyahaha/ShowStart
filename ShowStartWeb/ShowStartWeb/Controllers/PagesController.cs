...
namespace ShowStartWeb.Controllers
{
    ...
    public class PagesController : Controller
    {
        ...
        public ActionResult Collect()
        {
            ...
            //IQueryable<showstarts> ShowsList = ShowStartBll.LoadEntities(u => u.ReadDate == today).OrderBy(u => u.starttime);
        ...
        public ActionResult Show()
        {
            ...
            IQueryable<showstarts> ShowsList = ShowStartBll.LoadEntities(u => u.showname != "").OrderBy(u => u.startime);
            ...
            ViewData.Model = ShowsList;

            return View("Show", ShowsList);
        }
